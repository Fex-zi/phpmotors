...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 05, 2023 at 03:34 AM
...
(24, 'Now we wanna write lots of reviews just to test how long the line can be, so i will multiply the reviews.Now we wanna write lots of reviews just to test how long the line can be, so i will multiply the reviews.Now we wanna write lots of reviews just to test how long the line can be, so i will multiply the reviews.', '2023-12-02 17:48:40', 3, 8),
(25, 'Wow thats really good and Lambos are pretty cars.', '2023-12-02 19:42:18', 3, 9),
(26, 'Camaro is a very beautiful car', '2023-12-02 23:25:27', 10, 8),
(27, 'Vey beautiful Jeep with nice color.', '2023-12-03 04:42:10', 1, 8),
(28, 'I really like camaro&#039;s design a lot.', '2023-12-03 04:59:16', 10, 9);
...
ALTER TABLE `reviews`
  ...
  ADD KEY `FK_Reviews_clientId` (`clientId`),
  ADD KEY `FK_Reviews_invId` (`invId`);
...
--
ALTER TABLE `reviews`
  ADD CONSTRAINT `FK_Reviews_clientId` FOREIGN KEY (`clientId`) REFERENCES `clients` (`clientId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_Reviews_invId` FOREIGN KEY (`invId`) REFERENCES `inventory` (`invId`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
