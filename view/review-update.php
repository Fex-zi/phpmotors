...
echo "<i>Reviewed on $reviewDate </i>";
?> 
<hr>
<form action="/phpmotors/reviews/" method="post">
    <label for="clientReview" class="acc">Review Text:</label><br>
    <textarea  id="clientReview" name="clientReview" class="acc-tx" required ><?php echo $checkRev['reviewText']; ?></textarea><br>
    <input type="hidden"  name="revId" value="<?php echo $checkRev['reviewId']; ?>" >
      <input type="hidden"  name="action" value="update">  
      <input type="submit" class="lgn-btn" value="Update Review">
